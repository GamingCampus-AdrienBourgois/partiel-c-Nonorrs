...
int main(int argc, char** argv)
{
	...
	Exercice1::AutograderRunTest(1, 0);
	Exercice1::AutograderRunTest(1, 1);
	Exercice1::AutograderRunTest(1, 2);
	Exercice1::AutograderRunTest(1, 3);
	Exercice1::AutograderRunTest(1, 4);
